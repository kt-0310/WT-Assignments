...
<body>
	<video autoplay muted loop class="myVid">
		...
		<form  method="post">
			<table cellpadding="15px">
				<tr>
					...
					<td>
						<input type="text" id="fname" name="FistNm" data-placeholder="NAME" required><br>
					</td>
				</tr>
				<tr>
					<td>
					...
					<td>
						<input type="text" id="lname" name="LstNm" required ><br>
					</td>
				</tr>
				<tr>
					<td>	
                ...
                <tr>
					...
					<td>
						<input type="Password" id="pass" name="pwd" data-placeholder="PASSWORD" required><br>
					</td>
				</tr>
				<tr>
					<td>
